...
export declare class IntelligenceService {
    private readonly db;
    constructor(db?: import(".prisma/client").PrismaClient<import(".prisma/client").Prisma.PrismaClientOptions, never, import("@prisma/client/runtime/client").DefaultArgs>);
    /**
